  ...
  state: {
    works: [
...

      {
        ...
        descr:
          "Для использование требуется регистрация. Для backend было использовано firebase. Живая комната, место где в режиме реального времени могут переписываться участники.",
        site: "https://outdoors-shatlyk.netlify.app",
        github: "https://github.com/Shatlyk1011/natours",
