  ...
  state: {
    works: [
...

      {
        title: "Natours",
        descr:
          "Landing page, со сложными компонентами. На этом сайте, модальное окно(при нажатии на карточки) реализовано на чистом CSS. Однозначно стоит вашего внимание",
      ...
      },
      {
        title: "Google Works",
        descr:
          "Страница была сделана на подобии careers.google.com. Отличный пример использование всевозможных свойств на Vue.",
